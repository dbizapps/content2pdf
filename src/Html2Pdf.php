...
/*
 * This file is part of the render-pdf package.
 *
...
namespace dbizapps\Content2Pdf;

use dbizapps\Content2Pdf\Renderer;
use dbizapps\Content2Pdf\Exceptions\ContentException;
